  ...
  const projects = [
    {
      ...
      location: 'Florida',
      image:
        '/static/images/projects/36227162_10213541801434087_4964089476633591808_n.jpg',
      rating: 3,
      membersCount: 5,
...
mock.onGet('/api/projects/projects/1').reply(() => {
  const project = {
    ...
    activities: [
      ...
      },
      {
        ...
        createdAt: moment()
          ...
          .toDate()
          .getTime(),
        description: 'reviewed sumbission #1',
        subject: 'Ron Zaleski',
        type: 'join_team'
      },
      {
      ...
      },
      {
        ...
        createdAt: moment()
          ...
          .toDate()
          .getTime(),
        description: 'responded to step 1',
        subject: 'Mentee',
        type: 'price_change'
      },
      {
    ...
    caption:
      "We're looking for experienced Developers and Product Designers to come aboard and help us build succesful businesses through software.",
    currency: '$',
    description: `This is my response to three things I am grateful for....`,
    endDate: moment()
      .add(14, 'days')
      .toDate()
      .getTime(),
