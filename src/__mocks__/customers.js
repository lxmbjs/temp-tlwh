...
mock.onGet('/api/customers').reply(() => {
  const customers = [
    ...
    },
    {
      ...
      country: 'USA',
      currency: '$',
      email: 'alex.richardson@growthquo.com',
      hasAcceptedMarketing: true,
      isProspect: true,
      isReturning: false,
    ...
    },
    {
      ...
      country: 'USA',
      currency: '$',
      email: 'anje.keizer@growthquo.com',
    ...
    },
    {
      ...
      country: 'Spain',
      currency: '$',
      email: 'katarina.smith@growthquo.com',
      hasAcceptedMarketing: true,
      isProspect: false,
      isReturning: true,
      name: 'Katarina Smith',
    ...
    },
    {
      ...
      country: 'USA',
      currency: '$',
      email: 'adam.denisov@growthquo.com',
      hasAcceptedMarketing: true,
      isProspect: true,
      isReturning: false,
      name: 'Adam Denisov',
    ...
    },
    {
      ...
      country: 'USA',
      currency: '$',
      email: 'miller.edwards@growthquo.com',
      hasAcceptedMarketing: false,
      isProspect: true,
      isReturning: false,
      name: 'Miller Edwards',
    ...
    },
    {
      ...
      currency: '$',
      email: 'emilee.simchenko@growthquo.com',
      hasAcceptedMarketing: true,
      isProspect: false,
      isReturning: false,
      city: 'Carson City',
    ...
    },
    {
      ...
      country: 'USA',
      currency: '$',
      email: 'elliott.stone@growthquo.com',
      hasAcceptedMarketing: true,
      isProspect: false,
      isReturning: true,
      name: 'Elliott Stone',
    ...
    },
    {
      ...
      country: 'USA',
      currency: '$',
      email: 'merrile.burgett@growthquo.com',
      hasAcceptedMarketing: false,
      isProspect: false,
      isReturning: true,
